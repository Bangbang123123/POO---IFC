...
public class ContatoMain {
	...
	public static void startMenu(Scanner input, ContatoController lista) {
	...
	public static void arrumarIds(ContatoController lista) {
		int i = 0;
	...
	public static Contato selecionarContato(Scanner input,ContatoController lista) {
		boolean fechar = false;
	...
	public static void verContatos(ContatoController lista) {
		System.out.println("╔══════════════════════════════════════════╗");
	...
	public static void alterarContato(Scanner input,ContatoController lista) {
		boolean fechar = false;
		while (!fechar) {
	        ...
	        case 4:
	        	...
	        	dado = input.nextLine();
	        	contato.setData_nascimento(dado);
	        	break;
	...
	public static void criarContato(Scanner input,ContatoController lista) {
		boolean fechar = false;
		while (!fechar) {
			System.out.println("╔════════════════════════════════════════════╗");
	...
	public static void deletarContato(Scanner input, ContatoController lista) {
		boolean fechar = false;
		while (!fechar) {
			System.out.println("╔═════════════════════════════════════════╗");
	...
	public static void main(String[] args) {
		...
		ContatoController lista = new ContatoController();
